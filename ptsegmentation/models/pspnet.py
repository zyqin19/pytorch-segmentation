...
res101_url = 'https://download.pytorch.org/models/resnet101-5d3b4d8f.pth'
...
class PSPNet(nn.Module):
    def __init__(self, n_classes, pretrained=True, use_aux=True):
        super(PSPNet, self).__init__()
        self.use_aux = use_aux
        resnet = models.resnet101()
        if pretrained:
            state_dict = load_state_dict_from_url(res101_url)

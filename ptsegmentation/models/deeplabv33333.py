...
from ptsegmentation.models.resnet import ResNet18_OS16, ResNet34_OS16, ResNet50_OS16, ResNet101_OS16, ResNet152_OS16, ResNet18_OS8, ResNet34_OS8
...
class DeepLabV33(nn.Module):
    def __init__(self, n_classes=21, model_id='1', project_dir='./deeplabv3'):
        super(DeepLabV33, self).__init__()

...
# paper url : https://arxiv.org/abs/1807.10221
# github url : https://github.com/yassouali/pytorch_segmentation
import numpy as np
import torch
...
class UperNet(BaseModel):
    ...
    def __init__(self, n_classes, in_channels=3, backbone='resnet101', pretrained=True, use_aux=True, fpn_out=256,
                 freeze_bn=False, **_):
